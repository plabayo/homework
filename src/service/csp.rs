...
/// Declare a `static` inline `<style>` from a file under
/// `src/service/<path>` together with its build-script-generated hash.
/// Private by default; prefix the name with a visibility specifier (e.g.
/// `pub`) to export it — follow Rust's own item-visibility rules.
///
/// Usage:
/// ```ignore
/// crate::inline_style!(STYLE, "clock.css", EXERCISES_CLOCK_CSS_HASH_B64);
/// crate::inline_style!(pub STYLE, "clock.css", EXERCISES_CLOCK_CSS_HASH_B64);
/// ```
///
...
macro_rules! inline_style {
    ($vis:vis $name:ident, $path:literal, $hash_const:ident) => {
        $vis static $name: $crate::service::csp::InlineStyle =
...
/// for the general shape (including the optional visibility specifier).
#[macro_export]
macro_rules! inline_script {
    ($vis:vis $name:ident, $path:literal, $hash_const:ident) => {
        $vis static $name: $crate::service::csp::InlineScript =
...
macro_rules! inline_module_script {
    ($vis:vis $name:ident, $path:literal, $hash_const:ident) => {
        $vis static $name: $crate::service::csp::InlineModuleScript =
...
/// (including the optional visibility specifier).
#[macro_export]
macro_rules! inline_ld_json {
    ($vis:vis $name:ident, $path:literal, $hash_const:ident) => {
        $vis static $name: $crate::service::csp::InlineLdJson =
